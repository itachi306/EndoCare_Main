      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-semibold mb-4">Message Endometriosis Specialists</h2>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4">Medical Experts</h2>
          <div className="space-y-4">
            {[
              { name: 'Endometriosis Specialist', email: 'specialist@endocare.com' },
              { name: 'Nutritionist', email: 'nutritionist@endocare.com' },
              { name: 'Support Group Coordinator', email: 'support@endocare.com' },
            ].map((contact, index) => (
